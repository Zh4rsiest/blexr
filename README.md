...
3. Create a database, import the `config/database.sql` file to your database then delete it.
4. Edit the `config/database.sample.php`, `config/mail.sample.php` and `config/config.sample.php` files and delete the `.sample` part
